...
NEW: Super Mario Lost Land PLUS (2.5) available now!!!
...
+ new added story
+ removed all major bugs/softlocks from SMLL+ (2.5)
...
+ minor design changes in level 3-1, 3-2, 4-1 & 4-2 (2.4)
+ fixed a bug and a softlock in level 4-1 (2.5)
+ just some small level/graphics changes (2.6)
...
Have fun with this (softlock-free) final version called Super Mario Lost Land PLUS (2.6)!
